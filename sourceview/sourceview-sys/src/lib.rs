...
impl ::std::fmt::Debug for GtkSourceStyleSchemeChooserButtonClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GtkSourceStyleSchemeChooserButtonClass @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
impl ::std::fmt::Debug for GtkSourceStyleSchemeChooserInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GtkSourceStyleSchemeChooserInterface @ {:p}", self))
...
impl ::std::fmt::Debug for GtkSourceStyleSchemeChooserWidgetClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GtkSourceStyleSchemeChooserWidgetClass @ {:p}", self))
         .field("parent", &self.parent)
         .finish()
    }
}
...
extern "C" {
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v3_14")))]
    ...
    #[cfg_attr(feature = "dox", doc(cfg(feature = "v3_10")))]
