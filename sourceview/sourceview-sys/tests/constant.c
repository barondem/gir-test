...
int main() {
    ...
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_ALL);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_LEADING);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_NBSP);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_NEWLINE);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_SPACE);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_TAB);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_TEXT);
    PRINT_CONSTANT((guint) GTK_SOURCE_DRAW_SPACES_TRAILING);
